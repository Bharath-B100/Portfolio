  ...
  return (
    <div 
      ...
      style={{
        ...
        alignItems: 'center', 
        transition: 'clip-path 0.4s cubic-bezier(0.65, 0, 0.35, 1), opacity 0.4s ease-in-out', 
    ...
    >
      ...
      <div style={{textAlign: 'center'}}>
          <p style={{color: '#000000', fontWeight: 600, fontSize: '1.5rem', margin: '0', letterSpacing: '1px'}}>Loading<span className="shaking-dots">...</span></p>
      </div>
    </div>
  );
}
